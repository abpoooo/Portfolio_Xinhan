        ...
        return (
            <div className='burger'>
                ...
                <Menu right>
                    ...
                    <a id="about" className="menu-item" href="/about">About                     <svg className="bi bi-person-fill hover" width="2em" height="2em" viewBox="0 0 20 20"
                    ...
                    <a id="portfolio" className="menu-item" href="/portfolio">Portfolio                     <svg className="bi bi-eye-fill hover" width="2em" height="2em" viewBox="0 0 20 20"
                                                                                                                 fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a id="contact" className="menu-item" href="/contact">Contact  <svg className="bi bi-envelope-fill hover" width="2em" height="2em" viewBox="0 0 20 20"
                                                                                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
