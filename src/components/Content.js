        ...
        <div className='Content'>
            ...
            <div>
                ...
                <div className='Content_module2'>
                    <div className='Content_module2_Left'>
                        <h1>
                            Design
                        </h1>
                        <div className='Content_module2_Left_words'>
                            <p align='left'>
                    ...
                    <div className='Content_module2_Right'>
                        ...
                        <div className='Content_module2_Right_words'>
                            <p align="left">
                                McMaster University
                                ...
                                Western University
                                <br/>
                                Master of Engineering in Electrical Engineering(Communications and Signal Processing)
                                Mark2Win boot-camp
                                Boot-Camp for full-stack developer for JavaScript, React, HTML, SCSS, Redux and Node.Js.
